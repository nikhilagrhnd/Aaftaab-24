export const eventNameToDescMap = {
  video_making_workshop: {
    name: "Script to Video (Video Making Workshop)",
    description: `Always wanted to visualize your words? This is your chance! We will be hosting a "Script to Video" event where you will be guided to convert your own scripts to fun videos.`,
    imgUrl:
  ...
  creative_writing_workshop: {
    name: "Spill the Ink (Creative Writing Workshop)",
    description: `Have you always had a "Creative Knack" but were not able to express yourself? This is your chance! We will be hosting a "Spill the Ink" workshop where you will be guided to pen down your thought in a lucrative way which does justice to your imagination.`,
    imgUrl:
      "https://lettering-daily.b-cdn.net/wp-content/uploads/2018/09/me-doing-calligraphy-2.jpg",
  },
  acting_workshop: {
    name: "Nautanki Saala (Acting Workshop)",
    description: `Are you the person who acts and imitates someone else in parties or gatherings? This is the time to put your skills for more formal use! We will be hosting an "Acting Workshop" for all those who want to learn the bits and pieces of acting`,
    imgUrl:
  ...
  prompt_poetry: {
    name: "Verse Come Verse Serve(Prompt Poetry)",
    description: `Are you into poetry? Then brush up your skills because "Verse Come Verse Serve" is more than about words and melody. It's about quick thinking, creative imagination and of course poetry!`,
    imgUrl:
  ...
  noob_quiz: {
    name: "Noob Quiz",
    description: `"Noob Quiz" is for total beginners to come together and break the myth that quizzes are for nerds and have some REAL FUN!`,
    imgUrl:
  ...
  word_games: {
    name: "Are Your Words-Worth?(Word Games)",
  ...
  regional_literature_colloquium: {
    name: "Regional Literature Colloquium",
    description: `Immerse yourself in the beauty of regional literature and get the oppurtunity to interact with prolific authors of the genre as they discuss their works, stories, struggles and much more!`,
    imgUrl:
  ...
  treasure_hunt: {
    name: "Clueminati (Treasure Hunt)",
    description: `Are you into solving the clues and making your way through wilderness in pursuit of long lost treaure? We offer you all this thrilling experience in Aaftaab 2022's very own "Clueminati"!`,
    imgUrl:
  ...
  standup_comedy: {
    name: "Comedy Central (Standup/Satirical Comedy)",
    description: `Come and join us for an evening filled with jokes, laughter and a touch of sarcasm, brought to you by one of the finest comics in the conutry!`,
    imgUrl:
  ...
  hindi_debate: {
    name: "Hindi Debate/Hindi Extempore",
    description: `Come witness and participate a good old school "Hindi Debate"`,
    imgUrl:
  ...
  prompt_based_character_re_enactment: {
    name: "What If They Met (Prompt based character re-enactment)",
  ...
  mythology_quiz: {
    ...
    "`,
    imgUrl: "https://wallpaperaccess.com/full/6793384.jpg",
  ...
  english_author_book_signing: {
    name: "English Author Book Signing",
  ...
  mela_quiz: {
    name: "Let's Get Quizzical (MELA Quiz)",
    description: `Quiz can be fun. But themed quiz is definitely fun! Bringing to you the last but not the least event of Aaftaab 2022, the "MELA QUIZ!"`,
    imgUrl:
